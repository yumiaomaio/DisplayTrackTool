...
export const translations = {
  en: {
    ...
    windowMatrix: 'Window Matrix',
    windowMatrixDesc: 'Force-sync target window to specific ratios based on max vertical pixels. Note: Non-native ratios may cause UI displacement.',
    ...
    logs: {
      ...
      locked: (w, h) => `> Display matrix locked at ${w}:${h}.`,
  ...
  zh: {
    ...
    targetCore: '核心目标',
    windowMatrix: '窗口矩阵',
    windowMatrixDesc: '强制同步目标窗口至指定比例。系统将以显示器最大垂直像素为基准进行重算。注意：非原生比例可能导致部分应用 UI 布局偏移。',
    aspectRatio: '宽高比 (宽 : 高)',
